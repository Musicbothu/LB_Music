...
API_ID = int(getenv("API_ID", 23663709))
API_HASH = getenv("API_HASH", e4cadcb016165f55b2c827e61ee3e61a)

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("BOT_TOKEN", 7007876323:AAHDAOEOZoNt93SccJKvBdlAJZTPOES7SG8)
...
LOGGER_ID = int(getenv("LOGGER_ID",  7158173844))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", @sparklersgroup))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ishq_ka_safar")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/sparklersgroup")
